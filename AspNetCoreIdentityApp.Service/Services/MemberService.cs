...
namespace AspNetCoreIdentityApp.Service.Services
{
    public class MemberService : IMemberService
    {
        ...
        public async Task<SelectList> GetGenderSelectListAsync(string userName)
        {
            var currentUser = await GetUserEditViewModelAsync(userName);
            return new SelectList(Enum.GetNames(typeof(Gender)), currentUser.Gender);
        }
